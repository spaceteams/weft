...
export function groupDiffByOrigin(result: OverlayEvaluationResult, deltas: readonly ValueDelta[]): GroupedDiff {
...
export function groupDiffByMetadataGroup(model: CompiledModel, deltas: readonly ValueDelta[]): GroupedDiff {
